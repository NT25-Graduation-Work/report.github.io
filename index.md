...
# 今回のスライドの解説
- 最後の発表会でも使用するためこれを残したい(ファイル紛失を懸念)
...
- ローカルではなく、出先でもブラウザのみで解決できるように
    - [Codespace](https://github.co.jp/features/codespaces)を使用することでiPadからでも即座に編集
